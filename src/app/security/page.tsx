...
const items = [
  { icon: Shield, title: 'SOC 2 Type II', desc: 'Annually audited. Security, availability, and confidentiality trust service criteria verified.', color: '#FF6600' },
  ...
  { icon: Eye, title: 'Zero Trust Access', desc: 'Every request authenticated and authorized. No implicit trust inside or outside the network.', color: '#9CA3AF' },
  ...
  { icon: RefreshCw, title: 'Disaster Recovery', desc: 'Automated backups every 6 hours. RPO under 1 hour, RTO under 4 hours.', color: '#E65C00' },
...
export default function SecurityPage() {
  return (
    <div style={{ minHeight: '100vh', backgroundColor: 'var(--bg)' }}>
      ...
      <section style={{ paddingTop: '120px', padding: '120px 24px 60px', textAlign: 'center', background: '#F5F5EE' }}>
